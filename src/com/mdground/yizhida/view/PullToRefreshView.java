...
public class PullToRefreshView extends LinearLayout {
	...
	private boolean noFlashByFoot = false;

	public boolean isNoFlashByFoot() {
		return noFlashByFoot;
	}

	public void setNoFlashByFoot(boolean noFlashByFoot) {
		this.noFlashByFoot = noFlashByFoot;
	}
	...
	private void addHeaderView() {
		...
		LayoutParams params = new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, mHeaderViewHeight);
	...
	private void addFooterView() {
		...
		LayoutParams params = new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, mFooterViewHeight);
		// int top = getHeight();
		// params.topMargin
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			mStartMotionY = (int) event.getRawY();
			break;
		case MotionEvent.ACTION_MOVE:
			int deltaY = y - mLastMotionY;
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.drawable.refresh);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
	...
	public void onFooterRefreshComplete() {
		...
		mFooterImageView.setImageResource(R.drawable.refresh);
		mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
