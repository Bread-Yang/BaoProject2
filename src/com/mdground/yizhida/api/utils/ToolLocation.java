...
public class ToolLocation {
	...
	public static LocationClient mLocClient = new LocationClient(MdgAppliction.gainContext());
	...
	public static boolean isGpsOPen() {
		LocationManager locationManager = (LocationManager) MdgAppliction
	...
	private static LocationClientOption configOptions() {
		...
		if (isGpsOPen()) {
			...
			if (ToolNetwork.getInstance().init(MdgAppliction.gainContext())
					.isConnected()) {
